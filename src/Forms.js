        ...
        <form>
          <div className={classes.formRow}>
            <span className="color-grey">
              <img src={src.imgSrc} alt="avatar" className={classes.avatar}/>               
            </span>
            <div className={classes.inputRow}>
              <input type="text" className={classes.myInput} placeholder="What do you want to ask about ?" onChange={this.ChangeTxt}/>
            </div>
          </div>
          <div className={classes.formRow}>
             <p> Here's : {this.state.username} </p>
          </div>
        </form>
